...
<body>
  ...
  <div class="content_wrapper">
    <div class="contaner">
      <a onclick="Convert_HTML_To_PDF()" href="#"><button class="btn btn-secondary">Download Image</button></a>
      <div class="row" id="contentToPrint">
      @foreach($get_data as $event)
      <div class="col-12 col-md-6" style="margin-bottom: 170px;">
      <div class="main" style="padding: 0px 10px;">
        ...
        <div class="row" style="text-align: center; color: red; margin-top: -8px;">
          <p style="font-size: 8px; color: red;">({{$event['get_newevent']->title}})</p>
        </div>
        
        <div class="row">
          <div style="text-align: right;"><img src="{{url($event['get_user']['passport'] )}}" height="70px" width="60px" class="profile"></div>
        </div>
        <?php
        ...
        <div class="row content_data" style="">
          <img src="{{url('/public/frontend/logo1.png')}}" height="131px" width="100px" >
          <div class="conte" style="position: absolute; width: 224px;">
            ...
            <div class="row">
              ...
              <div class="col-md-8 col-8 val_data"><span type="text" name="">{{$event['get_user']->code}}</span></div>
            </div>
            <div class="row">
              <div class="col-md-4 col-4 title_data">Name:</div>
              <div class="col-md-8 col-8 val_data"><span type="text" name="">{{$event['get_user']->name}} {{$event['get_user']->middlename}} {{$event['get_user']->lastname}}</span></div>
            </div>
