...
<div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="toolbar" id="kt_toolbar">
		<div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
			...
			<a class="btn btn-warning" href="{{ url('/other/all_single_reg_form/'.$event_id) }}">Download Form</a>
			<a class="btn btn-warning" href="{{ url('/other/all_single_card/'.$event_id) }}">Download Card</a>
							...
							<tr>
								...
								<td class="text-end">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true" style="">
										...
										<div class="menu-item px-3">
											<a href="{{url('/other/single_card/'.$data->id)}}" class="menu-link px-3">Download Card</a>
										</div>
