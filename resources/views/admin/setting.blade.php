                        ...
                        <div class="card-body">
                            <form method="post" id="settingform" action="{{$saveurl}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="formrow-commission-input" class="form-label">Commission</label>
                                            <input type="text" name="commission" value="{{ old('commission',isset($setting->commission) ? $setting->commission : '' )}}" class="form-control" id="formrow-commission-input" placeholder="Enter Your commission">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="formrow-inputState" class="form-label">Tournament show subadmin</label>
                                            @php
                                            $areas_of_intresres = [];
                                            if(isset($setting['event'])){
                                            $areas_of_intresres = explode(",", $setting['event']);
                                            }
                                            @endphp
                                            <select name="event[]" class="form-select select2 form-control select2-multiple" multiple="multiple" data-placeholder="Choose ...">
                                                <option value="">Select Areas of interests</option>
                                                @foreach($event as $aria)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            <label for="formrow-inputZip" class="form-label">Tiktok</label>
