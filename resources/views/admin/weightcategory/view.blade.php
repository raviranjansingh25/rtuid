...
<div class="main-content">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right add_button">
                                            <a href="{{route('weightcategory_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add</button></a>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('.table_data').DataTable({
                ...
                ajax: {
                    url: "{{ url('/admin/weightcategory-data') }}",
                    data: function(d) {
            ...
            $(document).on("click", ".delete-button", function(e) {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            url: "{{ url('admin/weightcategory/delete') }}",
                            datatType: 'json',
                            type: 'GET',
                            data: {
                                'id': id,
    ...
    <script type="text/javascript">
        function changeStatus(id, status) {
            ...
            $.ajax({
                url: "{{ url('admin/weightcategory/status') }}",
                type: 'GET',
                data: {
                    'id': id,
                    'status': status,
