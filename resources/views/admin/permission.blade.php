                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th><input type="radio" name="subadmin_id" value="{{$data->id}}" onclick="check('{{$data->id}}',this.value)" class="groupcheck accent"></th>
                                                    <td>{{$data->name}}</td>
                                                </tr>
                                                @endforeach
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-bordered">
                                            <tbody>
                                                @foreach($admingroup as $key=>$data)
                                                <tr>
                                                    <th><input type="checkbox" name="subadmin_id[]" value="{{$data->id}}" class="groupcheck accent" required></th>
                                                    <td>{{$data->name}}</td>
                                                </tr>
                                                @endforeach
