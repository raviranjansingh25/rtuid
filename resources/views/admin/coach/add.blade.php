                            ...
                            <form method="post" id="form-data" action="{{$saveurl}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="father_name" value="{{ old('father_name',isset($getdata->father_name) ? $getdata->father_name : '' )}}" class="form-control" placeholder="Enter Father Name">
                                    </div><br>
                                    
                                    <div class="col-md-6">
                                        <label class="form-label">DOB <span class="text-danger">*</span></label>
                                        <input type="date" name="dob" value="{{ old('dob',isset($getdata->dob) ? $getdata->dob : '' )}}" class="form-control" placeholder="Enter Date of Birth">
                                    </div>
                                    
                                    <div class="col-md-6">
                                        <label class="form-label">Grade <span class="text-danger">*</span></label>
                                        <input type="text" name="grade" value="{{ old('grade',isset($getdata->grade) ? $getdata->grade : '' )}}" class="form-control" placeholder="Enter grade">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="phone" id="mobile_code" name="phone" value="{{ old('phone',isset($getdata->phone) ? '+'.$getdata->country_code.' '.$getdata->phone : '' )}}" class="form-control" placeholder="Enter Your Phone Number">
                                        </div>
                                    </div>
