                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">Athlete</p>
                    ...
                    <div class="card mini-stats-wid">
                        <a href="#">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">Sub Admin</p>
                                        <h4 class="mb-0">{{$sub_admin}}</h4>
                                    </div>
                    ...
                    <div class="card mini-stats-wid">
                        <a href="#">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">Coach</p>
                    ...
                    <div class="card mini-stats-wid">
                        <a href="#">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">Referee</p>
                                        <h4 class="mb-0">{{$referee}}</h4>
                                    </div>
                    ...
                    <div class="card mini-stats-wid">
                        <a href="#">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">Tournaments</p>
