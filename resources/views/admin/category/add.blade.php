                                ...
                                <div class="row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="min" value="{{ old('min',isset($getdata->min) ? $getdata->min : '' )}}" class="form-control" placeholder="Enter Min Age">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Max Age <span class="text-danger">*</span></label>
                                                <input type="number" id="max" name="max" value="{{ old('max',isset($getdata->max) ? $getdata->max : '' )}}" class="form-control" placeholder="Enter Max Age">
                                            </div>
                                        </div>
