                ...
                <tr>
                  <td>
                    <table width="800" border="0" cellpadding="0" cellspacing="0" align="center" class="col">
                      <tbody>
                        <tr>
                          <td align="center"> <img src="teli-logo.png" alt="logo" border="0" /></td>
                        </tr>
                        <tr class="hiddenMobile">
                          <td height="40"></td>
                        </tr>
                          ...
                          <table width="300" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                            ...
                            <tr>
                                <td width="100%" height="10">
                                    <a href="#" style="font-size: 16px; line-height: 20px; vertical-align: top; color: black; font-weight: 400; letter-spacing: 1px; text-decoration: none;">hello@reallygreatsite.com</a>
                                </td>
                            </tr>
                            </tbody>
                          </table>
                            ...
                            <tbody>
                              <tr style="text-align: right;">
                                <td style="font-size: 16px; letter-spacing: 1px; color:  black; font-weight: 400;">
                                  <strong style="color: black;">Invoice No. :</strong> #012345
                                </td>
                              </tr>
                              <tr>
                                <td width="100%" height="5"></td>
                              ...
                              <tr  style="text-align: right;">
                                <td style="font-size: 16px; line-height: 20px; vertical-align: top; color: black; font-weight: 400; letter-spacing: 1px;">
                                    <strong style="color: black;">Date : </strong>12.06.2024
                                </td>
                              </tr>
                            </tbody>
                          </table>
                ...
                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    <tr style="padding: 8px 0px;">
                      ...
                      <td style="font-size: 16px; line-height: 20px; vertical-align: top; color: black; font-weight: 400; letter-spacing: 1px; padding: 8px 0px" width="25%" align="center">100</td>
                      ...
                      <td style="font-size: 16px; line-height: 20px; vertical-align: top; color: black; font-weight: 400; letter-spacing: 1px; padding: 8px 0px" width="25%" align="right">$100</td>
                    </tr>
          ...
          <td>
            <table width="750" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
              <tbody>
                <tr>
                  <td>
                    <img style="margin-left: 50px;" src="DLKJ.png">
                  </td>
                </tr>
                <tr>
