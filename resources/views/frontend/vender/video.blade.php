...
<style>
  ...
  .modal-backdrop.show {
    opacity: 0;
    /* Set the opacity to 0 to remove the blur */
  }
...
<div class="col-md-9">
  <a class="btn-border" data-bs-toggle="modal" href="#ConsultNotes" type="button">Consult Notes</a>
  <a class="btn-border" onclick="TreatmentPlan()" type="button">Treatment Plan</a>
  <section class="video-call" id="video-call">
    <div class="video-call-frame">
      ...
      <div class="call-action-button">
        ...
        <button class="end-call" style="display:none; "><img class="img-fluid" src="{{url('/public/')}}/phone-off.svg" alt="" onclick="TreatmentPlan()"></button>
