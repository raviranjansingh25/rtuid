                    ...
                    <div class="fxt-column-wrap justify-content-between">
                        ...
                        <div class="fxt-transformX-L-50 fxt-transition-delay-5">
                            <div class="fxt-middle-content">
                                ...
                                <div class="fxt-switcher-description1">Enter the email mobile number associated</div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="fxt-column-wrap justify-content-center">
                        <div class="fxt-form">
                            ...
                            <form method="POST" id="forgot_password" autocomplete="">
                                @csrf
                            ...
                            <div class="fxt-switcher-description3">Return to?<a href="{{url('/login')}}" class="fxt-switcher-text ms-1">Log in</a></div>
                        </div>
                    </div>
                </div>
            </div>
          ...
          if (res.status == 1) {
            ...
            swal({
              ...
              .then(() => {
                ...
                window.location.href = "{{ route('otp_page') }}?email=" + encodeURIComponent(res.email);
