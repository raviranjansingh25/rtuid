                ...
                <div class="col-lg-8">
                    <div class="fxt-column-wrap justify-content-between">
                        ...
                        <div class="fxt-transformX-L-50 fxt-transition-delay-3">
                            <a href="index.php" class="fxt-logo"><img src="{{url('public/frontend/')}}/img/logo-34.png" alt="Logo" width="150" height="150"></a>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="fxt-column-wrap justify-content-center">
                        <div class="fxt-form">
                          ...
                          @endif
                            <form action="{{route('otpVerify')}}" method="POST"  autocomplete="">
                              @csrf
                                <div class="form-group">
                                    <label for="email" class="fxt-label">Code Verification</label>
                                    <input type="text" class="form-control" name="otp" placeholder="Enter OTP number" required >
                                </div>
                                <div class="form-group">
                            ...
                            <p>If you haven’t received the OTP in your inbox, please make sure to check your Spam, Junk, or Important folders.
