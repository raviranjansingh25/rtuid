...
<!-- Mirrored from themes.iamabdus.com/star/2.2/setting.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Oct 2023 10:06:07 GMT -->
...
<body id="body" class="up-scroll" data-spy="scroll" data-target=".element-right-sidebar">
  ...
  <div class="main-wrapper setting">
      ...
      <div class="row">
        <div class="col-12">
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-4">
                <h3 class="text-uppercase mb-3">Account Settings</h3>
                <p class="text-primary mb-0">Change Your Password</p>
              </div>
              
              <form action="#" method="">
                <div class="form-group mb-4">
                  <input type="password" class="form-control form-control-lg rounded border-0" required="" placeholder="Old Password">
                </div>

                <div class="form-group mb-4">
                  <input type="password" class="form-control form-control-lg rounded border-0" required="" placeholder="New Password">
                </div>

                <div class="form-group mb-4">
                  <input type="password" class="form-control form-control-lg rounded border-0" required="" placeholder="Confirm New Password">
                </div>

                <div class="pt-2">
                  <button type="submit" class="btn btn-primary text-uppercase font-size-15 px-6 px-md-7">Update Password</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-4">
                <p class="text-primary mb-0">Change Your Email</p>
              </div>
          
              <form action="#" method="">
                <div class="form-group mb-4">
                  <input type="email" class="form-control form-control-lg rounded border-0" required=""
                ...
                <div class="pt-2">
                  <button type="submit" class="btn btn-primary text-uppercase font-size-15 px-2 px-md-6">Update email address</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <p class="text-primary">Change Settings</p>

              <div class="custom-control custom-checkbox mb-2">
                <input type="checkbox" class="custom-control-input" id="customCheckSettings1">
                <label class="custom-control-label settings-control-label" for="customCheckSettings1">
                  <span class="ml-0">Star Travel has periodic offers and deals on really cool destinations.</span>
                </label>
              </div>

              <div class="custom-control custom-checkbox mb-2">
                <input type="checkbox" class="custom-control-input" id="customCheckSettings2">
                <label class="custom-control-label settings-control-label" for="customCheckSettings2">
                  <span class="ml-0">Star Travel has fun company news, as well as periodic emails.</span>
                </label>
              </div>

              <div class="custom-control custom-checkbox mb-2">
                <input type="checkbox" class="custom-control-input" id="customCheckSettings3">
                <label class="custom-control-label settings-control-label" for="customCheckSettings3">
                  <span class="ml-0">I have an upcoming reservation.</span>
                </label>
              </div>

              <div class="pt-3">
                <button type="submit" class="btn btn-primary text-uppercase font-size-15 px-3 px-md-6">Update your account</button>
              </div>
            </div>
          </div>
        </div>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317" integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA==" data-cf-beacon='{"rayId":"81b164e76e0fbb7f","version":"2023.10.0","r":1,"token":"6ab1814688eb46d9922ef568cb561268","b":1}' crossorigin="anonymous"></script>
</body>
