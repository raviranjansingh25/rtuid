    ...
    <div class="row">
      <div class="col-xl-3 col-lg-4">
        <div class="profile-dr">
          ...
          ?>
          <h3 class="d-flex align-items-center gap-2 justify-content-center">{{$user->name}}, {{$sex}} <img class="img-fluid" src="{{url('/public/frontend/')}}/assets/images/varify.svg" alt=""></h3>
          <!-- <a href="#">{{$user->email}}</a>
          ...
          <div class="detail-dr">
            ...
            <h5><span class="d-block mb-2">Qualifications</span>
              {{isset($user_detail['get_quali']->title)?$user_detail['get_quali']->title:'N/A'}} in {{isset($user['get_detail']->year_graduated)?$user['get_detail']->year_graduated:'N/A'}} <br>
              <!-- MS in 2005 -->
            </h5>
          ...
          <div class="row">
            <div class="{{isset($user->video)?'col-lg-8':'col-lg-12'}} {{isset($user->video)?'col-md-6':'col-lg-12'}}">
              <div class="profile-dtl">
                ...
                <div class="lange d-flex gap-2 align-items-start">
                  <a href="{{url('/booking/'.get_encrypted_value($user->id, true))}}" class="btn-primary">Book a consultation with Dr {{$user->name}} <img class="ms-2" src="{{url('/public/frontend/')}}/assets/images/white-right-arrow.svg" alt=""></a>
                ...
                @else
                <button onclick="login_model()" class="btn-primary">Book a consultation with Dr {{$user->name}} <img class="ms-2" src="{{url('/public/frontend/')}}/assets/images/white-right-arrow.svg" alt=""></button>
