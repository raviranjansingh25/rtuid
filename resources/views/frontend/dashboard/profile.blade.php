...
<!-- Mirrored from themes.iamabdus.com/star/2.2/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Oct 2023 10:06:06 GMT -->
...
<head>
    ...
    <title>Profile - Personal Information - Star Travel</title>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-5 col-xl-4">
          <div class="mb-6 mb-md-0">
            <img class="w-100 lazyestload" data-src="assets/img/dashboard/profile-img-01.jpg" src="assets/img/dashboard/profile-img-01.jpg" alt="Generic placeholder image">
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-7 col-xl-8">
          <div class="d-flex justify-content-between align-items-baseline">
            <div class="mb-6 mb-md-4 mb-lg-6">
              <h2 class="text-uppercase font-weight-bold">Sergey Karen</h2>
          ...
          <ul class="list-unstyled">
            ...
            <li class="media media-profile-list">
              ...
              <div class="media-body ml-2">
                ...
                <a href="tel:+13623464367" class="text-gray-color hover-text-primary ml-md-1">(+1) 362-346-4367</a>
              </div>
            </li>
            ...
            <li class="media media-profile-list">
              ...
              <div class="media-body ml-2">
                <a href="mail:to" class="text-gray-color hover-text-primary">info@sergeykaren.com</a>
              </div>
            </li>
          </ul>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317" integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA==" data-cf-beacon='{"rayId":"81b164e5af5b3619","version":"2023.10.0","r":1,"token":"6ab1814688eb46d9922ef568cb561268","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from themes.iamabdus.com/star/2.2/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Oct 2023 10:06:07 GMT -->
</html>
