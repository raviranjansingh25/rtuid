      ...
      <div class="col-xl-3 col-lg-4">
        <div class="book-appointment-dr">
          <div class="book-profile-img">
            ...
            <div>
              <span class="sp-clr">{{$user->name}}</span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="usr_code">
      </div>
      </div>
      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="set_discount()">Submit</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  function booking_now() {
    ...
    swal({
      ...
      text: "You are booking in for " + date + " " + month + " at " + StartTimeValue + " (" + timezone + "). If this is correct, please click ok.",
      icon: false,
      buttons: true,
      successMode: true,
    }).then((willDelete) => {
