            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="alert alert-info mb-0">
                        <strong>Your District:</strong> {{ $assignedDistrictName }}
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0">{{$contactEnquery}}</h4>
                                    </div>
                    ...
                    <div class="card mini-stats-wid">
                        <a href="#">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">Group Events</p>
