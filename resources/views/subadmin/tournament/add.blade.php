                        ...
                        <div class="card-body">
                            <form method="post" id="form-data" action="{{ $saveurl }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" value="{{ old('title', $getdata->title ?? '') }}" class="form-control" placeholder="Enter title">
                                </div>

                                <div class="alert alert-info">
                                    District: <strong>{{ $assignedDistrictName }}</strong> (locked)
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select select2" multiple name="gender[]">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="event[]" class="form-control select2" multiple>
                                ...
                                <div class="mt-3">
                                    <button type="submit" class="btn btn-primary w-md">{{ $button ?? 'Submit' }}</button>
