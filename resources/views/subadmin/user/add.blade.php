                        ...
                        <form method="post" id="form-data" action="{{ $saveurl }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if(!empty($isSingleDistrict) && !empty($lockedDistrict))
                                        <input type="hidden" name="district" value="{{ $lockedDistrict }}">
                                        <input type="text" class="form-control" value="{{ optional($dist->first())->title }}" readonly>
                                        <small class="text-muted">Athlete code format: RTUID/{{ optional($dist->first())->short_code }}/SA/XXXX</small>
                                    @else
