...
class GalleryController extends Controller
{
    ...
    public function save(Request $request, $id = NUll)
    {
        if (!empty($id)) {
            ...
            $data          = new Gallery;
            $success_msg   = 'Gallery Added Successfully.';
            $nameValidator = 'required';
        }
    ...
    public function anydata(Request $request)
    {
        ...
        return Datatables::of($anydata)
            ...
            ->addColumn('action', function ($anydata) {
                ...
                $action = '<a href="' . url('/admin/gallery/add/' . $encrypted_id) . '"><i class="fas fa-edit" title="Edit" data-toggle="tooltip" data-placement="bottom"></i></a> &nbsp;&nbsp;  
