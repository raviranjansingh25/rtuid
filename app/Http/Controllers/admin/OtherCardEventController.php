...
class OtherCardEventController extends Controller
{
    ...
    public function reg_form_single($id){
        ...
        return view('admin.card.reg_form')->with($data);
    }
    ...
    public function single_card($id){
        ...
        $decrypted_id = get_decrypted_value($id, true);
        $apply = ApplyTournament::with('get_waight_cat')->where('id',$decrypted_id)->first();
        ...
        return view('admin.card.single_card')->with($data);
    }
    ...
    public function all_single_reg_form (Request $request,$id){
        ...
        return view('admin.card.all_single_reg_form')->with($data);
    }
    ...
    public function all_single_card(Request $request,$id){
        ...
        return view('admin.card.all_single_card')->with($data);
    }
}
