        ...
        <div class="row">
            <div class="col-md-3">
              <div class="profile">
                ...
                <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link py-4 px-0" id="v-pills-wallet-tab" data-toggle="pill" href="#v-pills-wallet" role="tab" aria-controls="v-pills-wallet" aria-selected="false">
            ...
            <div class="col-md-9">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade rounded bg-white show active ps-4" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    ...
                    <div class="tab-pane fade rounded bg-white ps-4" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-password-tab">
                        <h5 class="font-italic mb-2 mt-5">Your Personal Details</h5>
                            ...
                            <div class="col-lg-4 col-md-12">
                              ...
                              <div class="form-group">
                                <label for="Mobile Number">Mobile Number</label>
                                  <input type="text" id="mobile_code" name="mobile" value="{{isset($user->mobile)?$user->mobile:''}}" class="form-control" placeholder="Phone Number">               
                              </div>
                    ...
                    <div class="tab-pane fade rounded bg-white ps-4" id="v-pills-wallet" role="tabpanel" aria-labelledby="v-pills-wallet-tab">
                    ...
                    <div class="tab-pane fade rounded bg-white ps-4 bookings-tab" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                              ...
                              <div class="col-md-6">
                                <div class="prty-dtl-pr">
                                  ...
                                  <ul>
                                    ...
                                    <li><span>Booking Date</span>{{date_format( new DateTime($current_book['check_in']), 'D, d M y' )}} - {{date_format( new DateTime($current_book['check_out']), 'D, d M y' )}}</li>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="prty-dtl-pr">
                                  ...
                                  <ul>
                                    <!-- <li><span>Booking Date</span>Fri, 15 Dec 22 - Sat, 16 Dec 22</li> -->
                                    <li><span>Booking Date</span>{{date_format( new DateTime($past_book['check_in']), 'D, d M y' )}} - {{date_format( new DateTime($past_book['check_out']), 'D, d M y' )}}</li>
                    ...
                    <div class="tab-pane fade rounded bg-white ps-4 favoritee" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                    ...
                    <div class="tab-pane fade rounded bg-white ps-4 invite-fr" id="v-pills-invite" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                    ...
                    <div class="tab-pane fade rounded bg-white ps-4" id="v-pills-notifi" role="tabpanel" aria-labelledby="v-pills-settings-tab">
