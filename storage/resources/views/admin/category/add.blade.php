                            ...
                            <form method="post" id="form-data" action="{{$saveurl}}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category_type" class="form-select">
                                        ...
                                        <option value="1" {{ isset($getdata->category_type) ? $getdata->category_type==1 ? 'selected' : '' : '' }}>Room</option>
                                        <option value="2" {{ isset($getdata->category_type) ? $getdata->category_type==2 ? 'selected' : '' : '' }}>Food</option>
                                        <option value="3" {{ isset($getdata->category_type) ? $getdata->category_type==3 ? 'selected' : '' : '' }}>FAQ</option>
                                        <option value="4" {{ isset($getdata->category_type) ? $getdata->category_type==4 ? 'selected' : '' : '' }}>Hotel</option>
                                    </select>
                                </div>
