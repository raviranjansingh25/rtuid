                                ...
                                <div class="col-12">
                                    <form id="search-form" method="post">
                                        <div class="row">
                                          ...
                                          <div class="col-md-3">
                                            <label for="from_date">City</label>
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right add_button">
                                            <a href="{{route('vender_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add</button></a>
                                        </div>
        ...
        $.ajax(
        {
            ...
            success: function (res)
            {
                if (res == "Success")
                {
                    swal({
                    title: "Change Status!",
                    text: "Hotel Status Change Sussessfully",
                    icon: "success",
                    dangerMode: true,
                    buttons: false,
                    timer: 1000
               ...
               .then(() => {
                    ...
                    swal({
                    title: "Change Status!",
                    text: "Without room hotel not active.",
                    icon: "info",
                    dangerMode: true,
                    buttons: false,
                    timer: 2000
