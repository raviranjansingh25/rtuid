...
<div class="main-content">
                                ...
                                <div class="col-12">
                                    <form id="search-form" method="post">
                                        <div class="row">
                                          ...
                                          <div class="col-md-3">
                                            <label for="from_date">Descount%</label>
                                            <input type="text" name="discount" class="form-control" placeholder="Title">
                                          </div>
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right add_button">
                                            <a href="{{route('promo_code_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add</button></a>
                                        </div>
          ...
          var table = $('.table_data').DataTable({
            "bFilter": false,
              ...
              columns: [
                  ...
                  {data: 'descount_data', name: 'descount_data'},
          ...
          $(document).on("click", ".delete-button", function (e) {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax(
                            {
                                url: "{{ url('admin/promo_code/delete') }}",
                                datatType: 'json',
                                type: 'GET',
                                data: {
                                    'id': id,
    ...
    <script type="text/javascript">
      ...
      function changeStatus(id,status){
        ...
        $.ajax(
        {
            url: "{{ url('admin/promo_code/status') }}",
            type: 'GET',
            data: {
                'id': id,
                'status': status,
